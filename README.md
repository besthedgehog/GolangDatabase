...
- [ООП в golang](#ооп-в-golang)
  ...
  - [Ещё примеры встраивания](#ещё-примеры-встраивания)
...
- [⚡️ **Почему это круто:**](-почему-это-круто)
- [Указатели](#указатели)
...
- [Цикл range](#цикл-range)
  ...
  - [iota](#iota)
  - [Задаём свой формат вывода в Print и аналогах](#задаём-свой-формат-вывода-в-print-и-аналогах)
...
- [🧩 3. `errgroup.Group`](#-3-errgroupgroup)
- [Каналы](#каналы)
